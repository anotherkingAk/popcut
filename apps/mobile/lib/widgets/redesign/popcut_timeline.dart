            ...
            children: [
              GestureDetector(
                ...
                child: Container(
                  ...
                  child: Icon(Icons.zoom_out, size: 16, color: PopCutColors.textSecondary),
                ),
              ),
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  child: Icon(Icons.zoom_in, size: 16, color: PopCutColors.textSecondary),
                ),
              ),
            ],
          ),
...
class _TimelineGridPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (double t = 0; t < totalDuration; t += 1) {
